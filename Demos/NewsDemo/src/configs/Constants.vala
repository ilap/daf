...
namespace App.Configs {
    ...
    public class Constants {
        ...
        public abstract const string ID = "com.github.ilap.daf.demos.news";
        public abstract const string VERSION = "0.1.0";
        public abstract const string PROGRAME_NAME = "Apple News app challenge";
        public abstract const string APP_YEARS = "2018";
        public abstract const string APP_ICON = "com.github.ilap.daf.demos.news";
        public abstract const string ABOUT_COMMENTS = "Template for vala apps";
        public abstract const string TRANSLATOR_CREDITS = "Github Translators";
        public abstract const string MAIN_URL = "https://github.com/ilap/daf";
        public abstract const string BUG_URL = "https://github.com/ilap/daf/issues";
        public abstract const string HELP_URL = "https://github.com/ilap/daf/wiki";
