...
namespace SelectionInListDemo.View {
    ...
    public override Type get_column_type (int index) {
        debug ("get_column_type %d -> %d", index, num_columns);

    	Type result;     
		switch (index) {
	       	case 0: result = typeof (string); break;
	      	case 1: result = typeof (string); break;
	        case 2: result = typeof (int); break;
	       	default: result = Type.INVALID; break;
	    }
    	return result;
    }
