...
namespace ContactsDemo.DataAccess {
    public class FilePersonRepository : Object, IContactsRepository {	    
	    ...
	    construct {
			...
			if (contacts == null) {		
				...
				contacts.add (new Person ("Blick", "Bashful", 1));
				contacts.add (new Person ("Flick", "Doc", 2));
				contacts.add (new Person ("Glick", "Dopey", 3));
				contacts.add (new Person ("Plick", "Grumpy", 4));
				contacts.add (new Person ("Quee", "Happy", 5));
				contacts.add (new Person ("Snick", "Sleepy", 6));
				contacts.add (new Person ("Whick", "Sneezy", 7));
			}
		}
